...
public class MainActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final RelativeLayout buttonSettting = findViewById(id.net.gmedia.absensipsp.R.id.setting);
        buttonSettting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout layoutUtama = dialog.findViewById(R.id.layoutUtamaPopupPilihanSetting);
                ...
                LinearLayout btnGantiPassword = dialog.findViewById(R.id.btnGantiPassword);
                ...
                LinearLayout btnEditPin = dialog.findViewById(R.id.btnEditPin);
